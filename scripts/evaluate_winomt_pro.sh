...
corpus_fn=/private/home/eduardosanchez/phd_workplace/repos/mt_gender/data/aggregates/wino-mt_pro_mhbcut.txt
...
mt_systems=("wino-mt_pro_llama_fem" "wino-mt_pro_llama_masc" "wino-mt_pro_nllb")
...
do
    ...
    do
        ...
        ../scripts/evaluate_language.sh /private/home/eduardosanchez/phd_workplace/repos/mt_gender/data/aggregates/${lang}/wino-mt_pro_mhbcut.txt $lang $trans_sys > $out_file
    done
done
